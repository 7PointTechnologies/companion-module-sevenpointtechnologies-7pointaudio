	...
	getConfigFields() {
		return [
			...
			},
         {
            ...
            value: 'Set the Remote Control Port to the same setting in 7 Point Audio. Leave blank for the default value of 7788.'
         },
			{
				type: 'textinput',
				id: 'host',
			...
			},
         {
            ...
            value: 'Leave the IP address field blank if you wish to control the instance of 7 Point Audio installed on this computer. If you need to control a remote instance of 7 Point Audio, enter the IP address manually.'
         },
		]
	}
}